	...
	private void initGui() {
		...
		Form<UserDTO> form = new Form<UserDTO>("newuser_form", model) {
			...
			protected void onSubmit() {
				...
				boolean b = getNoCVService().addUser(u);
				
				getNoCVSession().setUser(u);
				
				setResponsePage(UpdateNoCVProfilePage.class);
			}
		...
		final PasswordTextField passwordConfirmacionField = new PasswordTextField(
				"passwordConfirmation"); //Form", new PropertyModel<String>(this, "passwordConfirmacionForm"));
